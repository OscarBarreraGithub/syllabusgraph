...
|---|---|---|
| Conceptual relationships | Extend the [reviewed inventory](../graphs/subjects/qft/concepts/README.md) with secondary associations or universal concept prerequisites when needed. Current connections project specific book relationships and preserve their narrower scope. | Full treatment evidence and bounded scientific review for new claims; human feedback on the current map. A coverage threshold or display selection does not establish a universal prerequisite chain. |
