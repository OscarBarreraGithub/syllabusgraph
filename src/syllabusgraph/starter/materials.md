...
Files are not processed just because they are in this directory. Attachment
connects a file to a reference and creates a working copy in the project's
ignored `.syllabusgraph/sources/` directory. You may also attach files from
