...
| Recorded dispatches in this interval | 537 |
| Recorded native results | 520 |
...
graph totals were collected at 2026-09-15T08:16:56.223557+00:00. These are cumulative
...
|---|---:|---:|
| `gpt-5.6-sol` / high | 299 | 287 |
| `gpt-5.6-terra` / high | 238 | 233 |
...
The shared graph has 1386 nodes and 1710 relationships,
representing 1591 book concepts. Shared construction and its
