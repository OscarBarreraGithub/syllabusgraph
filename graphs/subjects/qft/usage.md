...
| Recorded dispatches in this interval | 598 |
| Recorded native results | 580 |
...
graph totals were collected at 2026-09-15T16:29:48.875205+00:00. These are cumulative
...
|---|---:|---:|
| `gpt-5.6-sol` / high | 345 | 333 |
| `gpt-5.6-terra` / high | 253 | 247 |
...
The shared graph has 1841 nodes and 2559 relationships,
representing 2038 book concepts. Shared construction and its
