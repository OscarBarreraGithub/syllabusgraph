...
| Recorded dispatches in this interval | 531 |
| Recorded native results | 514 |
...
graph totals were collected at 2026-09-15T07:31:12.818941+00:00. These are cumulative
...
|---|---:|---:|
| `gpt-5.6-sol` / high | 294 | 282 |
| `gpt-5.6-terra` / high | 237 | 232 |
...
The shared graph has 1345 nodes and 1608 relationships,
representing 1551 book concepts. Shared construction and its
